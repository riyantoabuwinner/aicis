...
<div class="article-page-header">
    <div class="article-header-inner">
        <h1 class="article-title-main" style="margin-bottom: 0;">{{ $theme->title }}</h1>
    </div>
</div>
...
<div class="article-content-wrapper">
    ...
    <div style="margin-top: 50px; text-align: center;">
        <a href="{{ url('/') }}" class="btn btn-outline-primary" style="padding: 10px 30px; font-weight: 600; border-radius: 50px;">
