            ...
            <div style="width: 100%;">
                ...
                <div class="grid-column-flow themes">
                    ...
                    @php
                        ...
                        $bgStyleEven = "background: #1b5e20; box-shadow: 0 10px 20px rgba(27, 94, 32, 0.15);";
                        ...
                        $numberColorOdd = "#1b5e20"; 
                        $iconColorOdd = "#1b5e20"; 
                        $titleColorOdd = "#1b5e20"; 
                        $descColorOdd = "#4b5563";
